...
This demonstrates the realtime system using:
   AFNI_REALTIME_Mask_Vals All_Data_light
...
The basic test verifies that maskdump produces the same ROI-1 values that
realtime_receiver.py reports.  It *could* be extended to check the ROI
averages, too.
---------------------------------------------------------------------------
